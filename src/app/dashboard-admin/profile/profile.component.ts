...
export class ProfileComponent implements OnInit {
  ...
  RetrieveData() {
    ...
    this.dataService.FindData('/show-my-profile', this.user_ids).subscribe(res => {
      this.response = res;
  ...
  UpdateAccount() {
    ...
    if(!this.profileform.valid) {
      ...
      this.http.post(this.apiUrl+'/update-profile-form', UserData, { headers: headers }).subscribe(res => {
        this.response = res;
        console.warn(this.response);
