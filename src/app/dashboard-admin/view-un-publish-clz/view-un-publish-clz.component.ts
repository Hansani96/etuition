...
@Component({
  selector: 'app-view-un-publish-clz',
  templateUrl: './view-un-publish-clz.component.html',
  styleUrls: ['./view-un-publish-clz.component.scss']
})
export class ViewUnPublishClzComponent implements OnInit {
  ...
  getClz(){
    this.dataService.getData('/get-all-unpublish-clzs').subscribe(res=>{
      console.log(res)
      this.clzInfo = res;
    });
  }
